  ...
  return (
    <>
      ...
      >
        ...
        <button
          onClick={closeMobile}
          className="md:hidden absolute top-4 right-4 p-2 rounded-full hover:bg-gray-100 text-gray-500 transition-colors cursor-pointer z-50"
        >
          <MdClose size={24} />
        </button>
        ...
        <div className="pt-8 pb-6 px-4 flex flex-col items-center relative">
          ...
          <button
            onClick={toggle}
            className="hidden md:flex absolute -right-4 top-10 w-8 h-8 items-center justify-center bg-white border border-gray-100 rounded-full shadow-md text-k-medium-grey hover:text-k-orange transition-colors z-50 cursor-pointer"
          >
            {isOpen ? (
